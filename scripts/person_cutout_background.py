...
def main() -> None:
    ...
    run_dir = build_timestamped_run_dir(args.output_root, "person_cutout_background", label)
    write_run_profile(run_dir, category="person_cutout_background", label=label, args=args)
