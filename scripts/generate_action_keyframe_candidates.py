...
from generate_fullbody_reference_candidates import _workflow
...
ACTION_CANDIDATES: dict[str, tuple[ActionKeyframeCandidate, ...]] = {
    "run": (
        ActionKeyframeCandidate(
            name="run_peak_airborne",
            action="run",
            pose_variant="run_peak",
            seed_offset=0,
            positive_template=(
                "masterpiece, best quality, polished anime game sprite keyframe, one full-body character only, "
                "side view facing right, running pose at peak stride, one knee lifted forward, back leg extended, "
                "arms pumping opposite the legs, feet fully visible, centered on clean white background, "
                "crisp cel shading, {identity_traits}"
            ),
        ),
        ActionKeyframeCandidate(
            name="run_forward_stride",
            action="run",
            pose_variant="run_forward_stride",
            seed_offset=700,
            positive_template=(
                "masterpiece, best quality, polished anime game sprite keyframe, one full-body character only, "
                "right-facing side-view fast run stride, body leaning slightly forward, front leg reaching, rear leg kicking back, "
                "clear readable shoes and hands, clean white background, {identity_traits}"
            ),
        ),
    ),
    "hit_heavy": (
        ActionKeyframeCandidate(
            name="hit_heavy_recoil",
            action="hit_heavy",
            pose_variant="hit_heavy_recoil",
            seed_offset=0,
            positive_template=(
                "masterpiece, best quality, polished anime game sprite keyframe, one full-body character only, "
                "side view facing right, heavy damage recoil pose, upper body bent backward from impact, "
                "one foot sliding back, arms thrown upward, feet fully visible, clean white background, {identity_traits}"
            ),
        ),
        ActionKeyframeCandidate(
            name="hit_heavy_low_recover",
            action="hit_heavy",
            pose_variant="hit_heavy_low_recover",
            seed_offset=700,
            positive_template=(
                "masterpiece, best quality, polished anime game sprite keyframe, one full-body character only, "
                "right-facing side view heavy hit recovery pose, crouched low, one knee bent, one arm guarding body, "
                "readable silhouette, complete shoes, clean white background, {identity_traits}"
            ),
        ),
    ),
    "attack_sword": (
...
def _pose_image(variant: str, width: int, height: int) -> Image.Image:
    ...
    if variant == "run_peak":
        keypoints.update(
            {
                "neck": [0.52, 0.250],
                "right_elbow": [0.62, 0.390],
                "right_wrist": [0.59, 0.500],
                "left_elbow": [0.39, 0.405],
                "left_wrist": [0.35, 0.315],
                "right_knee": [0.62, 0.650],
                "right_ankle": [0.70, 0.780],
                "left_knee": [0.40, 0.700],
                "left_ankle": [0.31, 0.835],
            }
        )
    elif variant == "run_forward_stride":
        keypoints.update(
            {
                "neck": [0.535, 0.260],
                "right_wrist": [0.64, 0.450],
                "left_wrist": [0.38, 0.610],
                "right_knee": [0.66, 0.770],
                "right_ankle": [0.78, 0.900],
                "left_knee": [0.39, 0.660],
                "left_ankle": [0.25, 0.800],
            }
        )
    elif variant == "hit_heavy_recoil":
        keypoints.update(
            {
                "nose": [0.46, 0.150],
                "neck": [0.47, 0.285],
                "right_shoulder": [0.51, 0.310],
                "left_shoulder": [0.43, 0.315],
                "right_elbow": [0.58, 0.245],
                "right_wrist": [0.63, 0.175],
                "left_elbow": [0.39, 0.250],
                "left_wrist": [0.34, 0.180],
                "right_hip": [0.55, 0.545],
                "left_hip": [0.49, 0.550],
                "right_knee": [0.64, 0.735],
                "right_ankle": [0.75, 0.895],
                "left_knee": [0.46, 0.735],
                "left_ankle": [0.39, 0.910],
            }
        )
    elif variant == "hit_heavy_low_recover":
        keypoints.update(
            {
                "nose": [0.55, 0.215],
                "neck": [0.53, 0.345],
                "right_elbow": [0.62, 0.455],
                "right_wrist": [0.68, 0.560],
                "left_elbow": [0.44, 0.455],
                "left_wrist": [0.40, 0.560],
                "right_hip": [0.55, 0.620],
                "left_hip": [0.49, 0.620],
                "right_knee": [0.66, 0.755],
                "right_ankle": [0.72, 0.910],
                "left_knee": [0.42, 0.755],
                "left_ankle": [0.35, 0.910],
            }
        )
